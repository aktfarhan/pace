...
notes: a route slot, so the line a query names is read with its typos fixed; the typos example now misspells its station too
---
...
```
{"intent": "<one of: route, alert, parking-rules, schedule, info, off-topic>", "origin": "<place or null>", "destination": "<place or null>", "route": "<line or bus or null>", "day": "<monday..sunday, today, tonight, tomorrow, or null>", "edge": "<first, last, both, or null>", "deadline": "<clock time or null>", "reason": "<short sentence, no first-person>"}
```
...
- `route` - The line or bus the question is about: "red line", "green line b", "77", "silver line". Nothing named -> null.
...
```
{"intent": "route", "origin": "sullivan square", "destination": "chinatown", "route": null, "day": null, "edge": null, "deadline": "9:00 AM", "reason": "A to B with a deadline"}
```
...
```
{"intent": "route", "origin": "malden center", "destination": "kenmore", "route": null, "day": null, "edge": null, "deadline": null, "reason": "both endpoints named, so it is a trip"}
```
...
```
{"intent": "route", "origin": "porter", "destination": "cvs", "route": null, "day": null, "edge": null, "deadline": null, "reason": "a chain named as where the rider is heading is a destination"}
```
...
```
{"intent": "alert", "origin": null, "destination": null, "route": "39", "day": null, "edge": null, "deadline": null, "reason": "asks about current route 39 status"}
```
...
```
{"intent": "parking-rules", "origin": null, "destination": null, "route": null, "day": null, "edge": null, "deadline": null, "reason": "asks whether parking is legal at a given hour"}
```
...
```
{"intent": "schedule", "origin": "oak grove", "destination": "copley", "route": null, "day": null, "edge": null, "deadline": "5:30 PM", "reason": "departure-time recommendation with a deadline"}
```

**schedule, typos**

Query: "wen is the frist gren line frm rivrside on sundy"

```
{"intent": "schedule", "origin": "riverside", "destination": null, "route": "green line", "day": "sunday", "edge": "first", "deadline": null, "reason": "first-departure question, typos read through"}
```
...
```
{"intent": "schedule", "origin": "back bay", "destination": null, "route": "39", "day": null, "edge": null, "deadline": null, "reason": "upcoming-departure question, not a first or last"}
```
...
```
{"intent": "info", "origin": null, "destination": null, "route": null, "day": null, "edge": null, "deadline": null, "reason": "static accessibility fact about a stop, not a trip"}
```
...
```
{"intent": "off-topic", "origin": null, "destination": null, "route": null, "day": null, "edge": null, "deadline": null, "reason": "asks about an event, outside Pace scope"}
```
